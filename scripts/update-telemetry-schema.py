...
import yaml
import json
with open('extension/model/telemetry/metrics.yaml') as f:
    metrics = yaml.load(f, Loader=yaml.FullLoader)
with open('extension/model/telemetry/pings.yaml') as f:
...
with open('extension/model/telemetry/TelemetrySchema.js', 'w') as f:
